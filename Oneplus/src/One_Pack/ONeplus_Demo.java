...
public class ONeplus_Demo {
	...
	public void verifyLogin() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.id("email")).sendKeys("-FILL YOUR LOGIN NAME-");
		driver.findElement(By.id("pass")).sendKeys("-FILL YOUR LOGIN PASSWORD-");
	...
	public void verifyCheckout() {
		...
		driver.findElement(By.id("shipping-in-first-name")).sendKeys("-FILL YOUR NAME-");
		driver.findElement(By.id("shipping-in-telephone")).sendKeys("-FILL YOUR MOBILE NUMBER-");
		driver.findElement(By.id("shipping-in-pincode")).sendKeys("-FILL YOUR PINCODE-");
		driver.findElement(By.id("shipping-in-street1"))
				.sendKeys("-FILL YOUR ADDRESS-");
	...
	public void verifycase() {
		...
		driver.findElement(By.id("field-pincode")).sendKeys("-FILL YOUR PINCODE-");
		driver.findElement(By.xpath("//*[@id=\"page-accessory\"]/div[1]/section/div/div/div/div/div/div/div[2]/div/div[1]/div[5]/form/div[2]/button")).click();
		driver.findElement(By.cssSelector(".btn-add-to-cart")).click();
		driver.findElement(By.xpath("//*[@id=\"show-basket-info\"]")).click();
		driver.findElement(By.xpath("//*[@id=\"final_checkout\"]")).click();
